    ...
    <div className="w-full h-screen lg:border-b-2 border-neutral-900">
      <div className="flex w-full h-full flex-col lg:flex-row justify-center items-center px-[30px] lg:px-[10vw]">
        ...
        <div className="flex lg:h-full h-[380px] justify-center w-full items-center lg:items-start flex-col gap-5 bg-transparent z-[100]">
          ...
          <div>
            <h3 className="text-center lg:text-left text-3xl font-bold lg:text-[7vw] leading-none w-[100%] whitespace-nowrap lg:whitespace-normal text-neutral-900 ml-[-5px]">
              Front End Developer
            </h3>
          </div>
          ...
          <div className="flex gap-3 z-[100]">
            <Link href="#projects" className="">
              <button className="p-5 w-[150px] shadow-lg rounded-lg text-neutral-900 font-bold cursor-pointer hover:bg-neutral-900 hover:text-white hover:scale-110 duration-500 active:scale-75">
                See my projects
              </button>
            </Link>
            <Link href="/about">
