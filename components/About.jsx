    ...
    <div className='w-full'>
        <div className='my-[140px] px-[30px] lg:px-[10vw]'>
            <div className='flex mx-auto flex-col gap-6 w-full lg:w-[80%]'>
                ...
                <div><h3 className='text-center text-3xl font-bold lg:text-[3.1vw] leading-none w-[100%] text-neutral-900'>Hello! My name is Frans and I`m a Front End Developer. My main interest is in Software Development. Artificial Intelligence is also on my way though!</h3></div>
                <div className=''><h2 className='font-normal text-center text-xl text-neutral-400'>Currently, I`m living in Indonesia. And now, pursuing my study at university (My major is Computer Science). Love doing interesting things, such as talking to new people, discussing amazing technologies, and also interested in psychological issue in real life. I also have a <a className='font-bold text-neutral-500 hover:text-neutral-900 underline' href='https://youtube.com/c/FransGamingLow' target='_blank'>Gaming YouTube</a> channel.</h2></div>
            </div>
            ...
            <div data-aos="fade-up" data-aos-anchor-placement="top-center" className='mb-[260px] flex flex-col md:flex-row gap-20 mx-auto w-[80%]'>
                <div className='w-full text-center'>
                    ...
                    <div className=''><h2 className='font-bold text-center text-lg tracking-[2px] text-neutral-900'>HTML <span className='text-neutral-400'>-</span> CSS <span className='text-neutral-400'>-</span> JavaScript <span className='text-neutral-400'>-</span> SASS <span className='text-neutral-400'>-</span> Bootstrap <span className='text-neutral-400'>-</span> Tailwind CSS <span className='text-neutral-400'>-</span> React <span className='text-neutral-400'>-</span> Laravel <span className='text-neutral-400'>-</span> Next.js <span className='text-neutral-400'>-</span> React Native <span className='text-neutral-400'>-</span> C# <span className='text-neutral-400'>-</span> Dart <span className='text-neutral-400'>-</span> Flutter <span className='text-neutral-400'>-</span> Python</h2></div>
                </div>
                <div className='w-full text-center'>
                    <div className='uppercase'><h2 className='font-normal text-center text-lg tracking-[8px] text-neutral-400'>Tools I use</h2></div>
                    <div className=''><h2 className='font-bold text-center text-lg tracking-[2px] text-neutral-900'>Visual Studio Code <span className='text-neutral-400'>-</span> Figma <span className='text-neutral-400'>-</span> Android Studio <span className='text-neutral-400'>-</span> GitHub <span className='text-neutral-400'>-</span> Premiere Pro <span className='text-neutral-400'>-</span> CorelDRAW <span className='text-neutral-400'>-</span> Lightroom <span className='text-neutral-400'>-</span> MSI Afterburner <span className='text-neutral-400'>-</span> OBS Studio <span className='text-neutral-400'>-</span> Unity Engine</h2></div>
                </div>
            </div>
        </div>
    </div>
