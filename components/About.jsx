        ...
        <div className='my-[140px] px-[30px] lg:px-[10vw]'>
            ...
            <div data-aos="fade-up" data-aos-anchor-placement="top-center" className='mb-[260px] flex flex-col md:flex-row gap-20 mx-auto w-[80%]'>
                <div className='w-full text-center'>
                    ...
                    <div className=''><h2 className='font-bold text-center text-lg tracking-[2px] text-neutral-900'>HTML <span className='text-neutral-400'>-</span> CSS <span className='text-neutral-400'>-</span> JavaScript <span className='text-neutral-400'>-</span> SASS <span className='text-neutral-400'>-</span> Bootstrap <span className='text-neutral-400'>-</span> Tailwind CSS <span className='text-neutral-400'>-</span> React <span className='text-neutral-400'>-</span> Laravel <span className='text-neutral-400'>-</span> Next.js <span className='text-neutral-400'>-</span> React Native <span className='text-neutral-400'>-</span> C#</h2></div>
                </div>
                <div className='w-full text-center'>
