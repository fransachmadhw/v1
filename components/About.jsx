    ...
    <div className='w-full'>
        <div className='my-[140px] px-[30px] lg:px-[10vw]'>
            <div className='flex mx-auto flex-col gap-6 w-full lg:w-[80%]'>
                ...
                <div className=''><h2 className='font-normal text-center text-xl text-neutral-400'>Currently, I`m living in Indonesia. And now, pursuing my study at university (My major is Computer Science). At first, I was interested in Game Development, especially 3D. However, I realised that my laptop would not handle it. So yeah, I chose Web Development. And I hope what I`ve learnt in Web Development can make me as a Professional Front End Developer and also leads me to Mobile Development easier than from zero knowledge. My hobbies are playing computer video games, singing, and editing a video. I also have a <a className='font-bold text-neutral-500 hover:text-neutral-900 underline' href='https://youtube.com/c/FransGamingLow' target='_blank'>Gaming YouTube</a> channel.</h2></div>
            </div>
            <div className='my-[100px] mx-auto w-[300px] h-[350px] sm:w-[500px] sm:h-[450px] lg:w-[800px] lg:h-[680px] relative overflow-hidden'>
                <div className='absolute z-[1] top-0 left-0 w-[200px] h-[150px] sm:w-[300px] sm:h-[220px] lg:w-[500px] lg:h-[400px]'>
                    <Image
                        src={Photo1}
                        placeholder='blur'
                        objectFit='cover'
                ...
                <div className='absolute z-[2] bottom-[100px] lg:bottom-[20%] right-0 w-[180px] h-[150px] sm:w-[280px] sm:h-[200px] lg:w-[450px] lg:h-[400px]'>
                    <Image
                        src={Photo2}
                        placeholder='blur'
                        objectFit='cover'
                ...
                <div className='absolute z-[3] bottom-[20px] sm:bottom-0 lg:bottom-0 left-[15%] w-[170px] h-[120px] sm:w-[250px] sm:h-[180px] lg:w-[350px] lg:h-[235px]'>
                    <Image
                        src={Photo3}
                        placeholder='blur'
                        objectFit='cover'
            ...
            <div className='mb-[260px] flex flex-col md:flex-row gap-20 mx-auto w-[80%]'>
